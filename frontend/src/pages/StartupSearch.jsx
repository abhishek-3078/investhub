...
const StartupSearch = () => {
  ...
  return (
    <div className="flex bg-gray-900 text-white min-h-screen w-full p-4">
      {/* Sidebar Filters */}
      <div className="w-1/4 p-4 bg-gray-800 rounded-lg">
        ...
        <input
          ...
          className="w-full p-2 text-sm border border-gray-700 bg-gray-900 rounded-md mb-3"
        />
        <select
        ...
        <select
          ...
          value={sortKey}
          className="w-full p-2 text-sm border border-gray-700 bg-gray-900 rounded-md"
        >
